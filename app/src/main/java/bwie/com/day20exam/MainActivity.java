...
public class MainActivity extends AppCompatActivity implements  ShopcartExpandableListViewAdapter.CheckInterface,
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        initView();
        initEvents();
        TextView i = (TextView) findViewById(R.id.subtitle);

        i.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImageView i = (ImageView) findViewById(R.id.subtitle);
            }
        });
    ...
    private void virtualData()
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            for (int j = 0; j <= i; j++)
            {
                ...
                products.add(new ProductInfo(j + "", "商品", "", groups.get(i).getName() + "的第" + (j + 1) + "个商品", 0.01 + i * j, 1));
            }
